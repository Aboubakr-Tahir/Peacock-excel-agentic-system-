...
def run_agents(query, manager, decision):
    ...
    if decision.agent_to_call == 'reporter':        
        ...
        report_agent = manager.get_report_agent(repo_path=repo_path, charts_path=charts_path, images_path=images_path, workspace_path=workspace_path, context_note_path=profiler_notes_path, queries_path=queries_path, web_images=web_images, summary_path=summary_path)
